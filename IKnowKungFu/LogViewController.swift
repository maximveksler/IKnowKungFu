...
public class LogViewController: UIViewController {
    ...
    @available(iOS 8.0, *)
    public func preferredContentSizeDidChangeForChildContentContainer(container: UIContentContainer)
    ...
    */
    @available(iOS 8.0, *)
    public func systemLayoutFittingSizeDidChangeForChildContentContainer(container: UIContentContainer)
    ...
    */
    @available(iOS 8.0, *)
    public func sizeForChildContentContainer(container: UIContentContainer, withParentContainerSize parentSize: CGSize) -> CGSize
...
public class UIViewController : UIResponder, NSCoding, UIAppearanceContainer, UITraitEnvironment, UIContentContainer, UIFocusEnvironment {
    ...
    */
    ...
    @available(iOS 6.0, *)
    public func shouldPerformSegueWithIdentifier(identifier: String, sender: AnyObject?) -> Bool // Invoked immediately prior to initiating a segue. Return NO to prevent the segue from firing. The default implementation returns YES. This method is not invoked when -performSegueWithIdentifier:sender: is used.
    @available(iOS 5.0, *)
    ...
    @available(iOS, introduced=6.0, deprecated=9.0)
    public func segueForUnwindingToViewController(toViewController: UIViewController, fromViewController: UIViewController, identifier: String?) -> UIStoryboardSegue?
    ...
    */
    ...
    @available(iOS 7.0, *)
    public func preferredStatusBarUpdateAnimation() -> UIStatusBarAnimation // Defaults to UIStatusBarAnimationFade
